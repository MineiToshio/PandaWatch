...
| Tocar un parser / filtro / extractor / scoring / dedup | [docs/reference/gotchas.md](docs/reference/gotchas.md) (las 93 gotchas) |
...
referencia (file map, las 7 decisiones, las 93 gotchas, convenciones, dashboard,
