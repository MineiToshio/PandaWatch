...
| Tocar un parser / filtro / extractor / scoring / dedup | [docs/reference/gotchas.md](docs/reference/gotchas.md) (las 103 gotchas) |
...
referencia (file map, las 7 decisiones, las 103 gotchas, convenciones, dashboard,
