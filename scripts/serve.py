...
# — antes estaban duplicadas byte-a-byte acá y en admin_serve.py. `mutates_items`
# se inyecta (con el mismo fallback que ya tenía este módulo si script_registry
# no está disponible) y log_prefix="serve" reproduce el prefijo de log que ya
# tenían los mensajes de este server ("[serve] PID ...").
